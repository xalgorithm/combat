...
function ursus_preprocess_html(&$variables) {
	global $base_url;
	
	$element_css = array(
	  '#tag' => 'link', 
	  '#attributes' => array(
	    'href' => $base_url . '/' . drupal_get_path('theme', 'ursus') . '/css/styles.css',
	    'rel' => 'stylesheet',
	    'media' => 'all'
	  ),
	  '#weight' => '-99999',
	...
	$element_modernizr = array(
	  '#tag' => 'script', 
	  '#attributes' => array(
	    'src' => $base_url . '/' . drupal_get_path('theme', 'ursus') . '/js/modernizr-2.6.2-respond-1.1.0.min.js'
	  ),
	  '#suffix' => '</script>'
	);	
  ...
  $selectivizr = array(
    '#tag' => 'script',
    '#attributes' => array(
      'src' => $base_url . '/' . drupal_get_path('theme', 'ursus') . '/js/selectivizr-min.js',
    ),
    //'#prefix' => '<!--[if lt IE 9]>',
    //'#suffix' => '</script><![endif]-->',
    '#suffix' => '</script>',
 ...
 */
function ursus_preprocess_node(&$variables, $hook) {
...
function ursus_menu_link(array $variables) {
...
function ursus_form_alter(&$form, &$form_state, $form_id) {
  if ($form_id == 'search_block_form') {

    $form['search_block_form']['#attributes']['placeholder'] = t('search URSUS');
